...
## ⚖️ Правовая оговорка (прочитай сначала)

Материал носит **информационно-технический характер**: это личный гайд по настройке клиента INCY (профиль маршрутизации) на iPhone. Он **не является рекламой и не продвигает** ни один VPN-сервис, не содержит призывов к его использованию и не предоставляет доступа к сторонним сервисам.

Автору известно, что законодательство РФ регулирует распространение информации о средствах обхода блокирования:
- **8-ФЗ «Об информации, информационных технологиях и о защите информации»** (ст. 15) — блокировка страниц с «информацией о способах, методах обеспечения доступа к информационным ресурсам, доступ к которым ограничен на территории РФ»;
- **Приказ Роскомнадзора от 17.10.2024 № 196** — критерии запрещённой информации, включая научно-технические данные о VPN-сервисах, используемых для обхода блокировок;
- **281-ФЗ от 31.07.2025** — поправки в КоАП РФ: реклама VPN-сервисов (ст. 14.2) и умышленный поиск экстремистских материалов (ст. 13.53);
- **282-ФЗ от 31.07.2025** — использование средств обхода блокирования при совершении преступления является отягчающим обстоятельством (ст. 63 УК РФ).

Автор **не призывает к обходу блокировок**, установленных в соответствии с законодательством РФ. Использование материала — на усмотрение и риск читателя, в соответствии с действующим законодательством РФ. По состоянию на дату публикации сам факт использования VPN физическим лицом административной ответственностью в КоАП РФ не предусмотрен. Текст не является юридической консультацией; за актуальным мнением обращайтесь к юристу.

<p align="center">
  <img src="incy-routing-qr.png" width="360" alt="QR — импорт профиля маршрутизации v6 в INCY">
</p>

**Сканируй этот QR камерой INCY — профиль «Socials via VPN» добавится и сразу активируется.** Подробности — в [Шаге 3](#шаг-3-добавь-готовый-профиль-маршрутизации-ключевой-шаг) ниже.
...
**Что делает профиль:**
- 34 сервиса (соцсети, мессенджеры, игры, стриминг, AI, работа и образование, путешествия) идут **через VPN**;
- все остальные приложения — **напрямую**, без VPN;
- IP-диапазоны серверов Telegram (DC1–DC5) тоже идут через VPN — приложение iOS подключается к DC по жёстко заданным IP, а не только по доменам.
...
Готовый профиль **«Socials via VPN»**:
...
- в `ProxyIp` — IP-диапазоны серверов Telegram (DC1–DC5) → они тоже идут **через VPN**.
...
```
incy:
```
...
## Что именно входит в профиль (34 сервиса)
...
Нужны потому, что Telegram для iOS подключается к серверам (DC) **по жёстко заданным в коде IP-адресам**, а не только по доменам — без этих диапазонов приложение не сможет синхронизироваться. Диапазоны сверены с данными [iplocate.io](https://iplocate.io/data/hosting-providers/telegram-org) и [v2rayN issue #5234](https://github.com/2dust/v2rayN/issues/5234).
...
**Вывод:**
- По умолчанию оба **выключены — и так правильно**. Если бы они ломали соединение, падали бы *все* сервисы сразу. Если не работает только один сервис (например, Telegram), а остальные работают — проблема в маршрутизации (проверь правила профиля), а не в настройках туннеля.
...
| Проблема | Решение |
|---|---|
| Telegram висит на «updating» | Перезапусти приложение; убедись, что VPN подключён и профиль активен (раздел «Маршрутизация») |
